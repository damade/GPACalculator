    ...
    when (this.getCgpa()) {
        ...
        in 3.50..4.49 -> {
            ...
            advice = if(rec <= 5.0){
                ...
                "You will need steady 5.0 GPAs to be able to get to First Class"
            }
        }
        in 2.40..3.49 ->{
            ...
            advice = if(rec <= 5.0){
                ...
                "You will need steady 5.0 GPAs to be able to get to Second Class Upper"
            }
        }
        in 1.50..2.39 -> {
            ...
            advice = if(rec <= 5.0){
                ...
                "You will need steady 5.0 GPAs to be able to get to Second Class Lower"
            }
        }
        in 1.00..1.49 -> {
