...
class StudentLoginFragment: Fragment() {
    ...
    private fun setupObserver() {
        loginViewModel.studentQueryResults.observe(viewLifecycleOwner){ userInfo ->
...
//        //OnClickForCalculation
        studentLoginIn.setOnClickListener {
            ...
            if (matricnumber.isNullOrEmpty() || password.isNullOrEmpty()) {
                ...
                loginViewModel.queryIfStudentExist(matricnumber, password, "Student")
            }
        }
        ...
        studentRegister.setOnClickListener { v ->
